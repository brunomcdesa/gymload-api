...
@NoArgsConstructor
@AllArgsConstructor
@Entity(name = "EXERCICIO_VARIACAO_HISTORICO")
public class ExercicioVariacaoHistorico extends HistoricoBase {
    ...
    @JoinColumn(name = "FK_EXERCICIO_VARIACAO", referencedColumnName = "ID",
        foreignKey = @ForeignKey(name = "FK_EXERCICIO_VARIACAO"), nullable = false)
    private ExercicioVariacao exercicioVariacao;
}
