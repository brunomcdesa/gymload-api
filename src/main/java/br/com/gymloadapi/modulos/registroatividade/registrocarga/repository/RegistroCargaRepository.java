...
@Repository
public interface RegistroCargaRepository extends JpaRepository<RegistroCarga, Integer>,
    QuerydslPredicateExecutor<RegistroCarga>, RegistroCargaRepositoryCustom {
