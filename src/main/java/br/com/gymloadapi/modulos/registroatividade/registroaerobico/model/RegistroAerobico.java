...
@NoArgsConstructor
@AllArgsConstructor
@Entity(name = "REGISTRO_AEROBICO")
public class RegistroAerobico extends RegistroAtividade {

    @Id
    @GeneratedValue(generator = "SEQ_REGISTRO_AEROBICO", strategy = SEQUENCE)
    @SequenceGenerator(name = "SEQ_REGISTRO_AEROBICO", sequenceName = "SEQ_REGISTRO_AEROBICO", allocationSize = 1)
    private Integer id;
